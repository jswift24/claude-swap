...
### Added
- `kimicc health` runtime health checks.
- `kimicc config path|show|init|edit` configuration management commands.
...
### Changed
- Improved `kimicc doctor` handling when kimicc services already own configured ports.
- Added actionable failure suggestions in `kimicc doctor` output.
